  ...
  return (
    <div className="min-h-screen p-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-1">
        {/* Form Section */}
        <div className="lg:col-span-3 bg-white p-6 border-r">
      ...
      {error && (
  <div className="fixed top-1/2 left-1/4 z-50 transform -translate-x-1/2 -translate-y-1/2 bg-red-600 text-white px-6 py-4 rounded shadow-lg animate-bounce">
    {error}
  </div>
)}
