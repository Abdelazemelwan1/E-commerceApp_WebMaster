        ...
        <div className='[justify-items:center] grid gap-4 md:grid-cols-[1fr_2fr_1fr] lg:grid-cols-[1fr_3fr_1fr]'>
          ...
          <div className='w-full flex items-center'>
            <div className="relative w-[90%] mx-auto ">
              <input type="search" id="location-search" className="font-normal bg-[#F3F4F7] text-[14px] text-[#9595A9] block p-2.5 w-full z-20 rounded-lg focus:outline-none" placeholder="Search for Products, fruit, meat, eggs .etc..." required />
              <button type="submit" className="absolute top-0 end-0 h-full p-2.5 text-sm font-medium text-black rounded-e-lg focus:outline-none">
                <svg className="w-4 h-4 text-[#3E445A] focus:outline-none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
